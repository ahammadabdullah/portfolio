      ...
      <div className="text-center mb-12">
        ...
        <div className="terminal max-w-4xl mx-auto text-left mb-8">
          ...
          <div className="font-mono text-sm">
            ...
            <br />
            <br />
            <span className="text-accent"># Ahammad Abdullah</span>
            <br />
            <br />
            <span className="text-text-secondary">
              A passionate Full Stack Developer who loves turning complex
              problems into elegant solutions. <br />I believe in writing clean,
