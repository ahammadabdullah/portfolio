...
const socialLinks = [
  ...
  {
    icon: SiCodechef,
    href: "https://www.codechef.com/users/class_vigor_18",
    label: "CodeChef",
    username: "@class_vigor_18",
  },
];
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <m.div variants={itemVariants} className="mb-12">
          <div className="terminal max-w-3xl mx-auto text-left mb-8">
            <div className="terminal-header">portfolio@ahammad:~$</div>
            <div className="font-mono text-sm">
              ...
              <br />
              <span className="text-text-secondary">
                Passionate about creating scalable solutions and turning ideas
                into reality
              </span>
            </div>
          </div>
          ...
          >
            ...
            <span className="badge badge-warning">Coffee Powered</span>
          </m.div>
        </m.div>
