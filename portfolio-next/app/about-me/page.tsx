    ...
    return (
      <div className="min-h-screen text-center flex flex-col gap-10 mb-20 items-center justify-center w-full">
        ...
        <div className="text-secondary text-left w-[80%]">
          ...
          <p>
            <span className="text-highlight">Comfortable:</span> NextJS, Mongoose, Redux, Redux Toolkit, Material UI
          </p>
          <p>
            <span className="text-highlight">Familiar:</span> Docker
          </p>
          <p>
            <span className="text-highlight">Tools and Platforms:</span>Vercel ,
            Firebase , Git, GitHub , GitLab, VS Code , Figma, Adobe Photoshop, MS Office
          </p>
          <p>
